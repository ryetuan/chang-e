...
date: 2025-08-29T11:08:59+01:00
...
params:
  ...
  published: '1895' # Year the book was published
  genre: ['Science Fiction', 'Fantasy', 'Classics'] # How you’d categorise the book, e.g. Fiction, Non-fiction, History, etc
  startdate: '23 Mar 2025' # Date you started reading the book
  enddate: '15 Apr 2025' # Date you finished reading the book
  rating: 4 # How you rated the book, must be an integer between 0 and 5
  format: 'Print' # Print, eBook, audiobook
  status: 'Read' # Reading status, e.g reading, read, want-to-read, abandonded
  url: 'https://www.goodreads.com/book/show/2493.The_Time_Machine' # URL for Goodreads, Amazon, Bookshop, etc
---
